...
<body>
	<form class="layui-form" action="updateCarInfo.do" method="post">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="carNum" required lay-verify="required"
					placeholder="请输入车牌号" autocomplete="off" class="layui-input" value="${requestScope.carMap.CAR_NUM }">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="carCapacity" required lay-verify="required"
					placeholder="请输入载客定员" autocomplete="off" class="layui-input" value="${requestScope.carMap.CAR_CAPACITY }">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<select name="carTypeId" lay-verify="required" id="carTypeId">
					...
					<c:forEach items="${requestScope.catTypeList }" var="m">
						<c:choose>
							<c:when test="${requestScope.carMap.CARTYPE_ID==m.CARTYPE_ID }">
								<option value="${m.CARTYPE_ID }"  selected="selected">${m.CARTYPE_NAME }</option>
							</c:when>
							<c:otherwise>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="brandModel" required
					...
					class="layui-input" value="${requestScope.carMap.BRAND_MODEL }">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="regTime" id="regTime" required
					...
					class="layui-input"  value="${requestScope.carMap.REG_TIME }">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="examinationTime" id="examinationTime" required
					...
					class="layui-input" value="${requestScope.carMap.EXAMINATION_TIME }">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="factoryNumber" required
					...
					class="layui-input" value="${requestScope.carMap.FACTORY_NUMBER }">
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
